...
$uploadPath = $_SERVER ["DOCUMENT_ROOT"] . '/uploadfile/employee/'; // 上传路径
...
$(function(){
    var d=eval('(<?=$picJson ?>)');
    if(d.success){
	    $('#employeeForm .person', parent.document).attr("src","<?=$base ?>"+d.path); 
	    $('#employeeForm input[name=picture]', parent.document).val(d.path);
    }
})
</script>
</head>
