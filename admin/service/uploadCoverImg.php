...
$uploadPath = $_SERVER ["DOCUMENT_ROOT"] . '/uploadfile/cover/'; // 上传路径
try{
...
$(function(){
    var d=eval('(<?=$picJson ?>)');
    if(d.success){
	    $('.img_cover .titleImg', parent.document).attr("src","<?=$base ?>"+d.path);
	    $('#infoTitleImgForm input[name=coverImg]', parent.document).val(d.path);
    }
})
</script>
</head>
